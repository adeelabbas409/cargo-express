...
export const H1Story: Story = {
  name: "H1",
  render: (args: any) => <H1>Taxing Laughter: The Joke Tax Chronicles</H1>,
  args: {},
}

export const H2Story: Story = {
  name: "H2",
  render: (args: any) => <H2>Taxing Laughter: The Joke Tax Chronicles</H2>,
  args: {},
}

export const H3Story: Story = {
  name: "H3",
  render: (args: any) => <H3>Taxing Laughter: The Joke Tax Chronicles</H3>,
  args: {},
}

export const H4Story: Story = {
  name: "H4",
  render: (args: any) => <H4>Taxing Laughter: The Joke Tax Chronicles</H4>,
  args: {},
}

export const PStory: Story = {
  name: "P",
  render: (args: any) => <P>Taxing Laughter: The Joke Tax Chronicles</P>,
  args: {},
}
...
export const LeadStory: Story = {
  name: "Lead",
  render: (args: any) => <Lead>Taxing Laughter: The Joke Tax Chronicles</Lead>,
  args: {},
}

export const LargeStory: Story = {
  name: "Large",
  render: (args: any) => <Large>Taxing Laughter: The Joke Tax Chronicles</Large>,
  args: {},
}

export const SmallStory: Story = {
  name: "Small",
  render: (args: any) => <Small>Taxing Laughter: The Joke Tax Chronicles</Small>,
  args: {},
}

export const SubtleStory: Story = {
  name: "Subtle",
  render: (args: any) => <Subtle>Taxing Laughter: The Joke Tax Chronicles</Subtle>,
  args: {},
}
